    ...
    return (
        <div className="max-w-7xl mx-auto lg:px-0 py-5">
            <div className="space-y-3">
                <h2 className="text-4xl font-bold text-center lg:text-left">Explore the <span className="bg-linear-to-r from-orange-500 via-pink-500 to-violet-600 bg-clip-text text-transparent">Technologies</span></h2>
